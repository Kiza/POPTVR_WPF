...
{
    public class RsPopModel
    {
        public static PoptvrModel AttributeReduction(PoptvrModel poptvr, DataSet dataset, AppConfig appConfig)
        {
            ...
            */
            ...
            fileWriter.WriteToFile(appConfig.getOutputFolder() + "Removed Attribute.txt", res);
            return poptvr;
        }
